...
class ESIM_Text_Matching(object):
...
if __name__ == '__main__':
    ...
    param_save_path = './param_dir/param_2021_03_29_15_26.pkl'
    # optional_reload_path = ""
    optional_reload_path = "model_15_-_0.3928.ckpt"
    ...
    ETM = ESIM_Text_Matching(cfg_path)

    # 初始化数据，开启训练
    # ETM.data_process_init()
    # ETM.train()

    # 加载已处理好的数据，开启训练
    # ETM.data_process_reload()
    # ETM.train()

    # 根据训练好的模型参数，预测整个测试集
    ETM.data_process_reload()
    ETM.make_all_predict(param_save_path,optional_reload_path)

    # 根据训练好的模型参数，预测样本
    # ETM.data_process_reload()
    # pred_dict = ETM.predict(words,param_save_path,ETM.dp.id2tag,optional_reload_path)
    # print(pred_dict)
