...
class Dssm_Text_Matching(object):
...
if __name__ == '__main__':
    ...
    param_save_path = './param_dir/param_2021_03_29_10_35.pkl'
    # optional_reload_path = ""
    optional_reload_path = "model_15___0.4316.ckpt"
    ...
    DTM = Dssm_Text_Matching(cfg_path)

    # 初始化数据，开启训练
    # DTM.data_process_init()
    # DTM.train()

    # 加载已处理好的数据，开启训练
    # DTM.data_process_reload()
    # DTM.train()

    # 根据训练好的模型参数，预测整个测试集
    DTM.data_process_reload()
    DTM.make_all_predict(param_save_path,optional_reload_path)

    # 根据训练好的模型参数，预测样本
    # DTM.data_process_reload()
    # pred_dict = DTM.predict(words,param_save_path,DTM.dp.id2tag,optional_reload_path)
    # print(pred_dict)
