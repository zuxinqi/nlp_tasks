...
class DPCNN_Classfication(object):
...
if __name__ == '__main__':
    ...
    DPC = DPCNN_Classfication(cfg_path)

    # 初始化数据，开启训练
    # DPC.data_process_init()
    # DPC.train()

    # 加载已处理好的数据，开启训练
    DPC.data_process_reload()
    DPC.train()

    # 根据训练好的模型参数，预测整个测试集
    # DPC.data_process_reload()
    # DPC.make_all_predict(param_save_path,optional_reload_path)
